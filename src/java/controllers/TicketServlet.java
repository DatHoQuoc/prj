...
public class TicketServlet extends HttpServlet {
    ...
    private final String ticketPage = "serviceTicket.jsp";
    /** 
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ArrayList<ServiceTicket> result = getAllServiceTicket();
    ...
    private ArrayList<ServiceTicket> getAllServiceTicket(){
        ServiceTicketDAO dao = new ServiceTicketDAO();
        dao.selectListOfServiceTicket();
        return dao.getServiceTicketList();
    }
}
